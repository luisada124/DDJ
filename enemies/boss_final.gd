...
@export var base_max_health: int = 2200
...
@export var base_laser_damage: int = 14
...
@export var phase1_fire_interval: float = 1.15
@export var phase2_fire_interval: float = 0.85
@export var phase3_fire_interval: float = 0.65
...
func _get_laser_damage() -> int:
	...
	return int(round(float(base_laser_damage) * m))
